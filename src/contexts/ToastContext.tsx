...
function ToastContainer({ position = 'bottom-right', toasts, remove }: ToastContainerProps) {
  const positionClasses = {
    ...
    'bottom-left': 'bottom-[calc(6rem+env(safe-area-inset-bottom,0px))] left-4',
    'bottom-center': 'bottom-[calc(6rem+env(safe-area-inset-bottom,0px))] left-1/2 -translate-x-1/2',
    'bottom-right': 'bottom-[calc(6rem+env(safe-area-inset-bottom,0px))] right-4'
  }
