    ...
    return (
      <div className="flex items-center justify-center min-h-screen bg-rb-canvas">
        <div className="text-center">
          ...
          <p className="text-blue-100 text-lg">Cargando órdenes del bar...</p>
        </div>
      </div>
    )
  }
        ...
        <div className="bg-gradient-to-r from-blue-600 to-cyan-700 text-white rounded-3xl shadow-xl overflow-hidden">
          <div className="px-6 py-8 sm:px-10 flex flex-col md:flex-row items-center justify-between gap-6">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-sm text-blue-100 uppercase tracking-tighter font-black">Área de Mixología</p>
                <h1 className="text-3xl sm:text-4xl font-black tracking-tighter uppercase">Bar</h1>
                <p className="text-blue-100 mt-1 font-bold opacity-80">GESTIÓN DE BEBIDAS EN VIVO</p>
              </div>
            </div>
