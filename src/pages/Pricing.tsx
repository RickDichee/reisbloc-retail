...
const PLAN_FEATURES = {
  ...
  starter: {
    ...
    features: [
      ...
      { text: '3 usuarios (cajero/admin)', included: true },
      { text: '2 cajas simultáneas', included: true },
      { text: 'Reportes de ventas', included: true },
      { text: '50 consultas AI/mes', included: true },
      { text: 'Inventario avanzado', included: true },
      { text: '100 clientes', included: true },
      { text: 'Catálogo web WhatsApp', included: true },
      { text: 'Facturación CFDI', included: false },
      { text: 'Multi-sucursal', included: false },
  ...
  growth: {
    ...
    features: [
      { text: 'Punto de Venta completo', included: true },
      { text: 'Hasta 1,000 productos', included: true },
      { text: '10 usuarios', included: true },
      { text: '5 cajas simultáneas', included: true },
      { text: 'Reportes ilimitados', included: true },
      { text: '200 consultas AI/mes', included: true },
      ...
      { text: 'Multi-sucursal (2)', included: true },
  ...
  scale: {
    ...
    features: [
      ...
      { text: '25 usuarios', included: true },
      { text: '10 cajas simultáneas', included: true },
      { text: '1,000 consultas AI/mes', included: true },
      { text: 'Multi-sucursal (5)', included: true },
      { text: 'API Access', included: true },
      { text: 'Soporte priority 24/7', included: true },
