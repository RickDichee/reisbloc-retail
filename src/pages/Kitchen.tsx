    ...
    return (
      <div className="flex items-center justify-center min-h-screen bg-rb-canvas">
        <div className="text-center">
          ...
          <p className="text-slate-600 text-lg font-bold">Cargando comandas...</p>
        </div>
      </div>
    )
  }
        ...
        <div className="bg-gradient-to-r from-blue-600 to-indigo-700 text-white rounded-3xl shadow-lg overflow-hidden">
          <div className="px-6 py-6 sm:px-8 flex flex-col md:flex-row items-center justify-between gap-6">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-sm text-blue-100 uppercase tracking-tighter font-black">Área de Producción</p>
                <h1 className="text-2xl sm:text-3xl font-black tracking-tight uppercase">Cocina</h1>
                <p className="text-blue-100 mt-1 font-bold opacity-80">GESTIÓN DE COMANDAS EN VIVO</p>
              </div>
            </div>
              ...
              return (
                ...
                >
                  ...
                  <div className="flex justify-between items-start mb-4">
                    <div>
                      <p className="text-3xl font-black text-slate-900">Mesa {order.tableNumber}</p>
