      ...
      <div style={{ marginBottom: '5px', borderBottom: '2px dashed #000', paddingBottom: '4px' }}>
        {Object.entries(itemsByCategory).map(([category, items]) => (
          <div key={category} style={{ marginBottom: '4px' }}>
            <div style={{ fontWeight: 900, fontSize: is80mm ? '11px' : '9px', textTransform: 'uppercase', color: '#000', borderBottom: '1px solid #000', padding: '1px 0', marginBottom: '3px' }}>
              {category}
            </div>
      ...
      {/* 📢 LEYENDA Y CONTACTO WHATSAPP CON DISEÑO MODERNO */}
        <div style={{
          ...
          <div style={{
            ...
            <svg width="13" height="13" viewBox="0 0 24 24" fill="#000000" style={{ display: 'inline-block', flexShrink: 0 }}>
            ...
            <span style={{ color: '#000' }}>WHATSAPP: 445 131 1808</span>
          </div>
        </div>
