...
export function ProductGrid({ products, onAdd, disableAdd = false }: ProductGridProps) {
  ...
  return (
    <div className="bg-white rounded-xl shadow-sm border border-gray-200 h-full flex flex-col">
      ...
      {/* Products Grid - Tarjetas Limpias y Elegantes */}
      <div className="flex-1 min-h-0 overflow-y-auto p-3">
        {filteredProducts.length === 0 ? (
          ...
          <div className="grid grid-cols-3 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-4 xl:grid-cols-5 gap-2.5">
            {filteredProducts.map(product => {
              ...
              return (
                <button
                  ...
                  disabled={disabled}
                  className={`group relative text-left rounded-2xl border overflow-hidden transition-all duration-150 active:scale-95 flex flex-col justify-between ${
                    disabled
